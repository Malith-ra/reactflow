...
import { Delete, Edit, GitBranch, LoaderIcon, Phone } from 'lucide-react';
...
const CallTransferNode: React.FC<NodeProps<PositionLoggerNode>> = ({
  id,
  data,
  isConnectable,
}) => {
  ...
  return (
    <div className="relative gap-2 bg-[#fff7ed] text-white rounded-lg shadow-md min-w-3xs cursor-grabbing">
      <div className="pt-3 pb-2 px-3">
        <div className="flex h-5 items-center justify-between gap-1.5">
          <div className="flex items-center gap-2">
            <div className="flex h-4 w-4 flex-shrink-0 items-center justify-center">
              <Phone className="w-3 h-3 text-[#db6617]" />
            </div>
...
export default CallTransferNode;
