...
const PressDigitNode: React.FC<NodeProps<PositionLoggerNode>> = ({
  id,
  data,
  isConnectable,
}) => {
  ...
  return (
    <div className="relative gap-2 bg-[#f0fdfa] text-white rounded-lg shadow-md min-w-3xs cursor-grabbing">
      <div className="pt-3 pb-2 px-3">
        <div className="flex h-5 items-center justify-between gap-1.5">
          <div className="flex items-center gap-2">
            <div className="flex h-4 w-4 flex-shrink-0 items-center justify-center">
              <QrCode className="w-3 h-3 text-[#47C2FF]" />
            </div>
